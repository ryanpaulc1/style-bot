 ...
 */
export async function installUtils(info, utils, hasConflict, hasCn) {
 ...
 */
export async function installComponents(info, components, resolution) {
 ...
 */
export async function mergeTailwindConfig(info, configPatch) {
 ...
 */
export async function installDependencies(info, tailwindVersion) {
    const deps = [
        '@radix-ui/react-slot',
 ...
 */
export async function installStyleMd(info, readme, styleName) {
    if (!readme)
        return;
 ...
 */
export async function installManifest(info, manifest, styleName) {
